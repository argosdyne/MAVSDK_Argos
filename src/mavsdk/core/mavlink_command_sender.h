...
public:
    ...
    void queue_command_async(const CommandInt& command, const CommandResultCallback& callback, unsigned retries = DEFAULT_RETRIES);
    void queue_command_async(const CommandLong& command, const CommandResultCallback& callback, unsigned retries = DEFAULT_RETRIES);
